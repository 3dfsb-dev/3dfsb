...
Major
-----
- More A/V formats: More than 100 audio and video container formats and decoders are now supported through the latest GStreamer
...
- More fun: you can now zap away at your files with the lasergun tool! Nothing is deleted from disk, for your own protection :-)
- Video input device (eg: webcam) file previews: V4L video capture devices these are now visible in the 3D world, just like your movies!
